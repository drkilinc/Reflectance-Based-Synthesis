function [h]=Plot_Circuitv1(varargin)
%
...
%
% Component types:
% To construct series L alone use the following code:
%         case 1,    'L in Serial branch                 ';
% To construct series C alone use the following code:
%         case 2,    'C in Serial branch                 ';
% To construct series R alnoe use the following code:
%         case 3,    'R in Serial branch                 ';
% -------------------------------------------------------------------------
% To construct parallel L//C//R use the following codes:
...
% To construct shunt L alone use the following code:
%         case 7,    'L in shunt branch                  ';
% To construct shunt C alone use the following code:
%         case 8,    'C in shunt branch                  ';
%         case 9,    'R in shunt branch                  ';
% -------------------------------------------------------------------------
% To construct series L,C, R circuit use the following codes:
...
for i=1:n,
	...
	elseif (abs(e(i))<1)&&(abs(e(i))>1e-3)
		kt=1e-3;
		un='m';
	elseif (abs(e(i))<1e-3)&&(abs(e(i))>=1e-6)
		kt=1e-6;
		un='\mu';
    elseif (abs(e(i))<1e-6)&&(abs(e(i))>=1e-9)
		kt=1e-9;
		un='n';
    elseif (abs(e(i))<1e-9)&&(abs(e(i))>=1e-12)
		kt=1e-12;
		un='p';
    elseif (abs(e(i))<1e-12)&&(abs(e(i))>=1e-15)
		kt=1e-15;
		un='f';
	else
		kt=1;
